...
// scenery: cenário de fundo do lago (null = lago do rio); sceneryFilter: filtro CSS opcional nele.
// sunlit: o ciclo dia/pôr do sol/noite vale.

export const DEPTH_LAYERS = [
  {
    id: 1, key: 'rio', name: 'Rio e Lagoa', shortName: 'Rio',
    minDepth: 0, maxDepth: 20, sunlit: true, scenery: null,
    themeColor: '#38bdf8', icon: '🏞️',
    desc: 'Água doce e rasa, onde toda jornada começa.'
  },
  {
    id: 2, key: 'sol', name: 'Zona do Sol', shortName: 'Sol',
    minDepth: 20, maxDepth: 200, sunlit: true, scenery: 'recife_bioluminescente',
    themeColor: '#0ea5e9', icon: '☀️',
    sceneryFilter: 'brightness(1.8) saturate(1.25) hue-rotate(-8deg)', // recife iluminado pelo sol
  ...
  },
  {
    ...
    minDepth: 200, maxDepth: 1000, sunlit: false, scenery: 'recife_bioluminescente',
  ...
  },
  {
    ...
    minDepth: 1000, maxDepth: 4000, sunlit: false, scenery: 'cemiterio_naufragios',
  ...
  },
  {
    ...
    minDepth: 4000, maxDepth: 6000, sunlit: false, scenery: 'fendas_vulcanicas',
  ...
  },
  {
    ...
    minDepth: 6000, maxDepth: 11000, sunlit: false, scenery: 'zona_hadal',
