...
export const FISH_LIST = [
  ...
  { numId:21, id:'peixe_sol_radiante', name:'Peixe-Sol Radiante', layer:2, rarity:'LENDARIO', icon:'peixe_sol', minWeight:30, maxWeight:110, baseValue:5500, desc:'Brilha com o calor dourado do meio-dia.' },
  { numId:22, id:'guardiao_crepusculo', name:'Guardião do Crepúsculo', layer:2, rarity:'LENDARIO', icon:'crepusculo', minWeight:35, maxWeight:140, baseValue:6000, desc:'Nada nas águas violeta que lembram o entardecer.' },
  { numId:23, id:'tubarao_fantasma_lunar', name:'Tubarão Fantasma Lunar', layer:2, rarity:'LENDARIO', icon:'tubarao_lunar', minWeight:45, maxWeight:160, baseValue:6500, desc:'Espectro prateado fluorescente que brilha como o luar da meia-noite.' },
  ...
  { numId:25, id:'leviata_prisma_solar', name:'Leviatã do Prisma Solar', layer:2, rarity:'MITICO', icon:'prisma_solar', minWeight:75, maxWeight:380, baseValue:21500, desc:'Colosso celestial que refrata a luz solar em feixes de energia pura.' },
  { numId:26, id:'fenix_ocaso_eterno', name:'Fênix do Ocaso Eterno', layer:2, rarity:'MITICO', icon:'fenix_ocaso', minWeight:80, maxWeight:420, baseValue:22500, desc:'Manifestação astral nascida do abraço entre o fogo solar e o crepúsculo.' },
  // ── CAMADA 3 ──
  { numId:101, id:'camarao_neon', name:'Camarão Neon Cristalino', layer:3, rarity:'COMUM', icon:'camarao_neon', minWeight:0.01, maxWeight:0.05, baseValue:17, desc:'Pequeno camarão da penumbra que sobe à noite para comer perto da superfície. Carapaça translúcida que emite pulsos azulados.' },
  { numId:102, id:'peixe_lanterna_prisma', name:'Peixe-Lanterna Prismático', layer:3, rarity:'COMUM', icon:'peixe_lanterna', minWeight:0.01, maxWeight:0.05, baseValue:17, desc:'Os peixes-lanterna são os vertebrados mais numerosos do planeta e sobem toda noite para caçar. Este refrata a luz em arco-íris.' },
  ...
  { numId:39, id:'lula_humboldt', name:'Lula-de-Humboldt', layer:3, rarity:'RARO', icon:'lula_humboldt', minWeight:5, maxWeight:50, baseValue:560, desc:'O diabo-vermelho: caça em bandos e pisca em vermelho e branco. Sobe à noite para caçar.' },
